...
| M5.0-27 | M5-D27 requirement-state counter ownership | Invent or omit a D24 requirement-state counter; alias a group/D25/byte counter; claim zero physical writes; omit requirement-state D25 patch/output evidence; reconstruct a count on replay; or change DTO/digest/schema/migration bytes | Static no-coordinate/five-owner inventory; group-registration actual-write accounting; D25 patch/bijection/replay checks; consistently rehashed surrogate-counter rejection; unchanged D24/D25 golden vectors and migration-016/017 regressions; report/nonclaim audit | PASS / PENDING |
